...
vim.wo.number = true
-- Set relative numbered lines (shows you how far away lines are from cursor)
...
vim.o.undofile = true
-- Copy indent from current line when starting a new one (default: true)
vim.autoindent = true
